...
The guild bank is open to all guild members -- if you see something you want or need, please make a request in `#🏦｜guild-bank` and an officer will fulfill it for you.

If you're interested in organizing events, ask an officer for the `Event Planner` role so that you can talk to `@raid-helper`.

Finally, please be sure to read `✅｜guild-information` for additional guild rules and policies. If you have any questions, please feel free to reach out to an officer.
    """,
    'Event Planner': """
...
Congratulations on your promotion to Raid Officer! Raid officers have access to all the tabs of the guild bank. Please use this privilege responsibly in support of your raid team.
    """,
    'Officer': """
Welcome to the inner circle. Now that you're an `Officer`, you have access to the `#👮｜officer-chat` and `officer-lounge` channels in Discord. You also have full access to the guild bank and officer chat (`/o` or `/officer`) in-game.
    """
}
